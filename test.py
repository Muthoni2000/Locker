...
class TestCredentials(unittest.TestCase):
	...
	def setUp(self):
		...
		'''
		self.new_credential = Credential('Sonn','Facebook','Brenda','pswd100')

	def test__init__(self):
		'''
		Test to if check the initialization/creation of credential instances is properly done
		'''
		self.assertEqual(self.new_credential.user_name,'Brenda')
		self.assertEqual(self.new_credential.site_name,'Facebook')
		self.assertEqual(self.new_credential.account_name,'Brenda')
	...
	# 	'''
	# 	self.twitter = Credential('Twitter','Brenda','')
